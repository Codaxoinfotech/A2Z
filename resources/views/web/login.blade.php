                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="index.html">
                            ...
                            <h2 class="brand-text text-primary ms-1">A2ZTech</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Welcome to A2ZTech 👋</h2>
                                <p class="card-text mb-2">Please sign-in to your account.</p>
                                <form class="auth-login-form mt-2" action="{{ route('userLoginPost') }}" method="POST">
                                    @csrf
                                    <div class="mb-1">
                                        <label class="form-label" for="mobile">Mobile</label>
                                        <input class="form-control" id="mobile" type="text" name="mobile"  aria-describedby="mobile" autofocus="" autocomplete="off" tabindex="1" />
                                    </div>
