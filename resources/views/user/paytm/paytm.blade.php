            ...
            <form action="{{ route('user.make.payment') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="mobile" value="{{ $user->mobile ?? '' }}" class="form-control" maxlength="10" placeholder="Mobile No." required>
                    </div>
                    <div class="col-md-12">
                        <strong>Email:</strong>
                    ...
                    <div class="col-md-12">
                        <br/>
                        <button type="submit" class="btn btn-success">{ay Service Charge Fee : {{ $pack }} Rs/-</button>
                    </div>
                </div>
            </form>
        </div>
