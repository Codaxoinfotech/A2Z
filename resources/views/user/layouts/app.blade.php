  ...
  <!-- END: Head-->
   ...
   <div class="sidenav-overlay"></div>
    ...
    <footer class="footer footer-static footer-light">
      <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT  &copy; @php date('Y') @endphp<a class="ms-25" href="#" target="_blank">A2ZTech</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span></p>
    </footer>
